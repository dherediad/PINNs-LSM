...
# Nombre del modelo:
nombre = 'r_rectangulo_100x100_5c_200n_sigmoid'
...
nombre_carpeta_principal = f'{nombre_carpeta_anterior}/rectangulo/{nombre}/'
...
u_ic = np.vstack(u_ic_rectangulo)

# Area teorica - Rectangulo (largo*ancho)
area_teorica = (rectangulo_y2-rectangulo_y1)*(rectangulo_x2-rectangulo_x1)

# Perimetro teorico - Rectangulo (2largo+2ancho)
perimetro_teorico = 2*(rectangulo_y2-rectangulo_y1) + 2*(rectangulo_x2-rectangulo_x1)
